...
//
//    public String findBestMatchWithThreshold(String target, List<Product> candidates, double similarityThreshold) {
...
//    }
//
//    public String findBestMatch(String target, List<Product> candidates, double similarityThreshold) {
//        String bestMatch = null;
//        double highestSimilarity = 0;
//
//        for (Product candidate : candidates) {
//            double similarity = calculateSimilarity(target, candidate.getName());
//            if (similarity > highestSimilarity && similarity >= similarityThreshold) {
//                highestSimilarity = similarity;
//                bestMatch = candidate.getName();
//            }
//        }
//
//        return bestMatch;
//    }
//
//    public Map<String, String> matchProducts(List<String> targetProducts, List<Product> candidateProducts, double similarityThreshold) {
